package aporia.cc.api.ui.menu.components.implement.window.implement.settings.group;

import lombok.Getter;
import net.minecraft.client.gui.DrawContext;
import net.minecraft.client.util.math.MatrixStack;
import net.minecraft.util.math.MathHelper;
import aporia.cc.module.api.setting.SettingComponentAdder;
...
import aporia.cc.api.ui.menu.components.implement.settings.AbstractSettingComponent;
