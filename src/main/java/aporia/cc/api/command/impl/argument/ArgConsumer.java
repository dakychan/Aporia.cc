...
package aporia.cc.api.command.impl.argument;

import aporia.cc.api.command.api.argument.IArgConsumer;
import aporia.cc.api.command.api.argument.ICommandArgument;
import aporia.cc.api.command.api.datatypes.IDatatype;
import aporia.cc.api.command.api.datatypes.IDatatypeContext;
import aporia.cc.api.command.api.datatypes.IDatatypeFor;
import aporia.cc.api.command.api.datatypes.IDatatypePost;
import aporia.cc.api.command.api.exception.CommandException;
import aporia.cc.api.command.api.exception.CommandInvalidTypeException;
import aporia.cc.api.command.api.exception.CommandNotEnoughArgumentsException;
import aporia.cc.api.command.api.exception.CommandTooManyArgumentsException;
import aporia.cc.api.command.api.manager.ICommandManager;
